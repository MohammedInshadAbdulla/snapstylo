...
export default function Nav() {
    ...
    // If we're on the home page, the page has its own specialized nav for now, 
    // but for other pages we use this shared Nav component.
    // We'll make this shared Nav match the styling exactly.
